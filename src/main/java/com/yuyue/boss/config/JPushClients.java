...
@Component
public class JPushClients {
    private static final Logger logger = LoggerFactory.getLogger(JPushClients.class);
    ...
    private PushResult sendPush(PushPayload pushPayload, String masterSecret, String appKey) {
        logger.info("pushPayload={}", pushPayload);
        PushResult pushResult = null;
        try {
            pushResult = this.getJPushClient(masterSecret,appKey).sendPush(pushPayload);
