...
public class AdReviewServiceImpl implements AdReviewService {
     ...
     */
    @Override
    public List<Advertisement> getAdReviewList(String id,String merchantName, String phone, String status, String applicationStartTime,String applicationEndTime) {
        return adReviewMapper.getAdReviewList(id,merchantName,phone,status, applicationStartTime,applicationEndTime);
    }
    /**
     * 修改广告商审核状态
     */
