...
public interface AdReviewService {
    ...
    List<Advertisement> getAdReviewList(String merchantName,String merchantAddr,String phone,String status,String applicationStartTime,String applicationEndTime);
